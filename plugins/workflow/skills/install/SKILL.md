...
5. **Emit the setup summary.** Keep it short:
   ...
   - Understanding gates now reachable: `/turkit:zoom-out`, `/turkit:visual-map`, `/turkit:work-brief`, `/turkit:explain-diff`, `/turkit:teachback-gate`, `/turkit:merge-brief`, `/turkit:release-brief`.
