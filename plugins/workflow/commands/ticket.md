---
description: Single ticket entrypoint. Default runs plan -> approval -> execute; flags support --triage, --plan, --execute, optional --grill, and low-token --fast.
argument-hint: "[--triage|--plan|--execute] [--grill] [--fast] <ticket-id | tracker-url | free-form description>"
