---
description: Single ticket entrypoint. Default runs plan → approval → execute; flags support --plan, --execute, and optional --grill.
argument-hint: "[--plan|--execute|--grill] <ticket-id | tracker-url | free-form description>"
